...
public class PixelPropsUtils {
    ...
    static {
        ...
        propsToChangePixelFold.put("ID", "TQ3A.230901.001");
        propsToChangePixelFold.put("FINGERPRINT", "google/felix/felix:13/TQ3C.230905.001.A1/10750268:user/release-keys");
